...
export default function RegisterPage() {
  ...
  // Sign-up failures from the server (e.g. email already in use) arrive under
  // `email`, alongside the schema's own field errors.
  ...
  return (
    <AuthShell
      ...
      subtitle="Free, and no card. Add your first application in a few seconds."
    >
      <motion.form
        action={formAction}
